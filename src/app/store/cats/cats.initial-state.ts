...
export const INITIAL_STATE: ICat[] = [
  {
    ...
    name: 'Bandit',
    headline: 'Frisky cat looking for a good home.',
  ...
  },
  {
    ...
    imageUrl: 'https://placekitten.com/105/105',
    age: 'kitten',
    gender: 'female',
    breed: 'domesticShort'
...
Stubbs would love to be adopted into a home where there is another kitty for her to play with.`,
  ...
  {
    id: '29068b98-d5d3-464c-93c4-055f7a8a2b70',
    name: 'Lucy',
    headline: 'In the sky with dimonds.',
    description: `<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas luctus mattis neque at faucibus. Pellentesque ac ligula pulvinar, malesuada nisl quis, semper felis. Nunc ac ullamcorper orci, dapibus finibus ligula. Quisque volutpat, libero et maximus tincidunt, nunc nunc porttitor mi, ut congue orci felis sit amet tortor. Donec diam velit, dignissim vitae sem eget, imperdiet congue ipsum.</p>`,
    imageUrl: 'https://placekitten.com/80/80',
    age: 'adult',
    gender: 'female',
    breed: 'domesticShort'
  ...
  {
    id: '0274c9df-9a7d-4a2b-942d-044ac95a53c1',
    name: 'Jolene',
    headline: 'Classy lady looking for a good lap.',
    description: `<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas luctus mattis neque at faucibus. Pellentesque ac ligula pulvinar, malesuada nisl quis, semper felis. Nunc ac ullamcorper orci, dapibus finibus ligula. Quisque volutpat, libero et maximus tincidunt, nunc nunc porttitor mi, ut congue orci felis sit amet tortor. Donec diam velit, dignissim vitae sem eget, imperdiet congue ipsum.</p>`,
    imageUrl: 'https://placekitten.com/80/80',
    age: 'senior',
    gender: 'female',
  ...
  {
    id: '53b90177-c9c5-432d-8850-1ce1c527d942',
    name: 'Hero',
    headline: 'Bold cat that loves to play.',
     description: `<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas luctus mattis neque at faucibus. Pellentesque ac ligula pulvinar, malesuada nisl quis, semper felis. Nunc ac ullamcorper orci, dapibus finibus ligula. Quisque volutpat, libero et maximus tincidunt, nunc nunc porttitor mi, ut congue orci felis sit amet tortor. Donec diam velit, dignissim vitae sem eget, imperdiet congue ipsum.</p>`,
    imageUrl: 'https://placekitten.com/80/80',
    age: 'adult',
    gender: 'male',
  ...
  {
    id: '63a78aa0-0096-469f-a38d-cc6643ec55a3',
    name: 'Tiggs',
    headline: 'Cat is a cat is a cat',
     description: `<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas luctus mattis neque at faucibus. Pellentesque ac ligula pulvinar, malesuada nisl quis, semper felis. Nunc ac ullamcorper orci, dapibus finibus ligula. Quisque volutpat, libero et maximus tincidunt, nunc nunc porttitor mi, ut congue orci felis sit amet tortor. Donec diam velit, dignissim vitae sem eget, imperdiet congue ipsum.</p>`,
    imageUrl: 'https://placekitten.com/80/80',
    age: 'adult',
    gender: 'male',
